...
const options = {
  url: 'https://dev51723.service-now.com',
  username: 'admin',
  password: 'bAmJaS7Exl9E'
};
 ...
 * @description Checks if request function responded with a valid response.
 *
 * @param {object} response - The response argument passed by the request function in its callback.
 *
 * @return {boolean} Returns true if response is valid. Otherwise returns false.
 */
